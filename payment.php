	                                        ...
	                                        <div class="blog_details_head m-top-40">
	                                            ...
	                                            <div class="head_text">
	                                                ...
	                                                <ul class="list-inline">                                                    
	                                                    <li><a href="#" class="text-black">Seu cadastro foi aprovado com sucesso! A partir de agora voc&ecirc; poder&aacute; inserir seus an&uacute;ncios!</a></li>                                                   
	                                                </ul>
	                                            </div>
	                                        </div> 
	                                        <div class="blog_details_figure m-top-40">                                         
	                                            <p>
	                                            Para dar prosseguimento a inclus&atilde;o de seus an&uacute;ncios, 
	                                            voc&ecirc; deve aderir a algum dos planos de contrata&ccedil;&atilde;o abaixo!<br>
	                                            Selecione o plano desejado que melhor atenda a sua necessidade:</p>
