...
if (!$functions->fGetEmail($_REQUEST['email'], 'usuarios'))
{
	$retRetrieve = $functions->fRetrievePassword($_REQUEST['email'], 'usuarios');
	...
	$message = '<html><img src="'.SIS_URL.'assets/images/logos/libidinous-transp-black.png"><br><br>
				...
				<a href="'.SIS_URL.'verify/2/'.$functions->fEncrypt($_REQUEST['email']).'">Alterar Minha Senha</a><br><br>
				Atenciosamente,<br>		
