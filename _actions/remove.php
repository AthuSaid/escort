...
{	
	$message = '<html><img src="'.SIS_URL.'assets/images/logos/libidinous-transp-black.png"><br><br>
				...
				Sua conta ser&aacute; removida do '.SIS_TITULO.' e seu perfil n&atilde;o estar&aacute; mais visivel no site!<br>
				Caso deseje voltar a utilizar o site, basta efetuar login novamente com seus dados de acesso que a conta ser&aacute;<br>
				automaticamente habilitada, de acordo com o seu &uacute;ltimo plano contratado.<br><br>				
				Atenciosamente,<br>
