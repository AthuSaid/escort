                            ...
                            <div class="col-md-12">
                                ...
                                <div class="ab_feature_content wow fadeIn m-top-40">
                                   ...
                                   <?php echo utf8_encode('
                                    		...
                                    		<strong><h6><i class="fa fa-warning"></i> 7 - Privacidade e Divulgação de Informação</strong></h6>
