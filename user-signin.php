<?php
    ...
    {		
		header('Location: '.SIS_URL.'profile');
    	exit;        		
    }      
?>
<!doctype html>
...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    <head>
        <meta charset="utf-8">
        <title><?php echo SIS_TITULO; ?> - Acesso do Usuario</title>
                        ...
                        <div class="col-md-12">
                            <div class="main_blog_details">
                                <div class="live_chate">                                
										...
										<h6>	
											<p>Cadastro restrito exclusivamente apenas para usu&aacute;rios maiores de <strong>18 ANOS</strong>, que devem respeitar as seguintes imposi&ccedil;&otilde;es:</p>											
											<p><strong>a.</strong> Todas as informa&ccedil;&otilde;es contidas no seu cadastro devem serem VERDADEIRAS assim como sua identidade.</p>											
                                    	...
                                    	<div class="row">                                    	                                    	 
                                           <div class="col-md-6">
                                           		<form method="post" role="form" name="form-user-signin-page" id="form-user-signin-page" data-toggle="validator">                                             		
		                                           	<div class="col-sm-12">  
                                            ...
                                            <div class="col-md-6">
                                            	<form method="post" role="form" name="form-user-signup-page" id="form-user-signup-page" data-toggle="validator">
		                                            <div class="col-sm-12">
		                                            	<h4><i class="fa fa-sign-in"></i> Novo Usu&aacute;rio</h4>                                             	                                                                                          
		                                                <div class="form-group">
