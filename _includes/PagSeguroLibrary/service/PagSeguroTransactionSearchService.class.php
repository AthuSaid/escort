...
class PagSeguroTransactionSearchService
{
    ...
    */
     ...
     * @return array
     */
    public static function buildParams($pageNumber, $maxPageResults, $initialDate, $finalDate = null)
    {
        $searchParams = array(
     ...
     * @throws PagSeguroServiceException
     */
    public static function searchResult($connection, $initialDate = null, $finalDate = null)
    {
